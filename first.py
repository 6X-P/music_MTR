...
st.set_page_config(page_title="MTR Aura | أورا الموسيقى", page_icon="✨", layout="centered")
    ...
    st.markdown(f"""
        <div class="music-card">
            ...
            <div class="btn-grid">
                ...
                <a href="{yt_link}" target="_blank" class="luxury-btn btn-red" style="grid-column: span 1;">
